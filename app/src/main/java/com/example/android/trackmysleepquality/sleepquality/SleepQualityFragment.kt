...
class SleepQualityFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        //Getting the Argument from Previous Fragment
        val argument = SleepQualityFragmentArgs.fromBundle(arguments!!)

        val application = this.activity!!.application
        val dataSource = SleepDatabase.getInstance(application).sleepDatabaseDao //Define SleepDatabase

        val viewModelFactory = SleepQualityViewModelFactory(argument.nightID, dataSource)
